...
if &t_Co >= 256 || has("gui_running")
    ...
    hi VertSplit ctermbg=bg ctermfg=233 cterm=NONE guibg=bg guifg=#04de04 gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi Identifier ctermbg=bg ctermfg=brown cterm=NONE
    ...
    hi StatusLine ctermbg=black ctermfg=blue cterm=NONE
    hi StatusLineNC ctermbg=black ctermfg=blue cterm=NONE
    hi link StatusLineTerm StatusLine
    hi link StatusLineTermNC StatusLineNC
    hi VertSplit ctermbg=bg ctermfg=blue cterm=NONE
    ...
    hi Operator ctermbg=bg ctermfg=darkgreen cterm=NONE
